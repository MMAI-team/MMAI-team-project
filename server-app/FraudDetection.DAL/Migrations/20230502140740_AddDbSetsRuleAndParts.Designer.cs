...
namespace FraudDetection.DAL.Migrations
{
    ...
    [Migration("20230502140740_AddDbSetsRuleAndParts")]
    partial class AddDbSetsRuleAndParts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FraudDetection.DAL.Entities.Rule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int?>("FraudScoreOperation")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FraudDetection.DAL.Entities.RulePart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FraudDetection.DAL.Entities.Transaction", b =>
                {
                    ...
                    b.Property<bool>("IsMarkedAsNotFraud")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FraudDetection.DAL.Entities.RulePart", b =>
                {
                    b.HasOne("FraudDetection.DAL.Entities.Rule", "Rule")
                        .WithMany("Parts")
